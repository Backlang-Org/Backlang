...
internal sealed class AssemblyResolver
{
    ...
    private static readonly string s_path =
        Path.GetDirectoryName(Path.GetFullPath(typeof(AssemblyResolver).Assembly.Location));

    /// <summary>
    ///     Resolve assembly.
    /// </summary>
    private static readonly ResolveEventHandler assemblyresolver = AssemblyResolve;
