...
public static class Intrinsics
{
    ...
    public static void Ldarg(ushort arg)
    {
        iLProcessor.Emit(OpCodes.Ldarg, arg);
    }

    public static void Ldarga(ushort arg)
    {
        iLProcessor.Emit(OpCodes.Ldarga, arg);
    }

    public static void Ldloc(ushort local)
    {
        iLProcessor.Emit(OpCodes.Ldloc, local);
    }

    public static void Ldloca(ushort local)
    {
